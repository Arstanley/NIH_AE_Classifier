...
import argparse 
from ae_generator import AugmentedImageSequence
import os
from utility import get_sample_counts
from weights import get_class_weights
from keras.utils import multi_gpu_model
from ClassificationCallback.ae_callback import MultipleClassAUROC, MultiGPUModelCheckpoint
...
def main():
    ...
    # dump history
    print("** dump history **")
    with open(os.path.join(outputs_path, f"history{args.model_epoch}.pkl"), "wb") as f:
        pickle.dump({
